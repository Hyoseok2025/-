...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // Vertex AI 엔드포인트 URL (streamGenerateContent 사용)
    const VERTEX_AI_URL = `https://${GCP_REGION}-aiplatform.googleapis.com/v1/projects/${GCP_PROJECT_ID}/locations/${GCP_REGION}/publishers/google/models/gemini-1.0-pro:streamGenerateContent`;
